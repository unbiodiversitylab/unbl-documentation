...
2.	Просмотрите показатели в левой панели. Выберите один из девяти динамических показателей или два основных индикатора, выбрав на дашборде опцию «ПОКАЗАТЕЛИ» или «ОСНОВНЫЕ ИНДИКАТОРЫ». Выберите один из девяти стандартных динамических показателей или два показателя по основным индикаторам, выбрав на отображаемой панели опцию «ПОКАЗАТЕЛИ» (Metrics) или «ОСНОВНЫЕ ИНДИКАТОРЫ» (Headline Indicators). Обратите внимание, что показатели по основным индикаторам и стандартный показатель по охраняемым территориям могут быть рассчитаны только для мест, относящихся к типу «страна».
...
5.	Чтобы загрузить сводные данные по показателю в формате .csv, .tsv или .json, нажмите на значок стрелки ![](images/icons/download-icon.png){style="display: inline; width: 1em; height: 2em; width: 2em;"}. Вы также можете загрузить данные по ссылкам на источники на страницах с информацией о наборах данных.  
