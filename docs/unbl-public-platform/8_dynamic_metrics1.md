...
- Protected Areas (2026)
- Protected Connected Index (2026)
- Tree Cover Loss (2001-2024)
- Monthly Fire Activity (2001-2025)
- Biodiversity Intactness Index (2015)
- Terrestrial Carbon Density (2010)
- Enhanced Vegetation Index (2001-2025)
- Terrestrial Human Industrial Index (2000, 2005, 2010, 2013)
- Coastal Eutrophication (2007-2024)

UN Biodiversity Lab additionally offers two headline indicators which are available as set out in the indicator metadata associated with Monitoring Framework of the Kunming-Montreal Global Biodiversity Framework ([CBD/DEC/COP/15/5](https://www.cbd.int/doc/decisions/cop-15/cop-15-dec-05-en.pdf); [CBD/DEC/COP/16/31](https://www.cbd.int/doc/decisions/cop-16/cop-16-dec-31-en.pdf)), which is available on the [Kunming-Montreal Global Biodiversity Framework Indicators website](https://gbf-indicators.org/) and in [CBD/COP/16/INF/3/Rev.1](https://www.cbd.int/doc/c/ea34/8414/8c5e6797d291af15f33d6e40/cop-16-inf-03-rev1-en.pdf):
...
| Protected Areas | Percentage of total land and marine area that is protected within a country. | This metric uses data from the World Database on Protected and Conserved Areas (IUCN, UNEP-WCMC). This metric is updated monthly. | The WDPCA is updated monthly and can be used to monitor changes in legally protected areas or, in conjunction with other datasets, monitor activity within and around protected areas. |
| Protected Connected Index | Percentage of total land area that is covered by connected protected areas, at distance thresholds of 1, 10, and 100 kilometers. | This metric pulls statistics directly from the BON in a Box ProtConn pipeline, which uses the WDPCA in calculating connectedness of protected areas. | the Protected Connected Index is an important indicator for assessing progress towards Goal A and Target 3 of the KMGBF, which aim to have 30% of land area protected by a network of well-connected protected areas by 2030. |
...
| Coastal Eutrophication | Shows the change in distribution of coastal eutrophication trends through chlorophyll-a concentration proxies for given coastal and/or marine locations between 2007-2024, grouped into various categories defining the strength and direction of the eutrophication trend. | This metric uses the Global Eutrophication Watch, a geospatial framework for the preliminary screening of Coastal Eutrophication Potential (CEP). The version on UNBL uses the ESA-CCI (Ocean Colour Climate Change Initiative) 4km-resolution dataset as the primary input. | This metric can be used to identify environmental hotspots and monitor the progress of coastal water quality over time. |
...
2.	Review the metrics in the left panel. Choose between a list of the ten terrestrial dynamic metrics, marine metric, or two headline indicators by clicking and selecting the preferred option - 'Metrics', 'Marine metrics', 'Headline indicators' - from the displayed dashboard.
