...
![Maps for Reports](images/gifs/17_download_global_data.gif)
...
3. For inclusion in formal reports or publications, please ensure you meet mapping standards:
   1. Maps should be clear and concise.
   2. Important text on maps should be clear and legible (e.g., cities, place names, legend items, etc.).
   3. The map should include basic mapping elements, including: a legend of relevant data layers and scale bar.
   4. The map must provide correct attribution(s) and citation(s) for the data source(s) used in its creation, either on the map itself or in a caption describing the map, e.g.:
